...
/*if(isset($_POST['bagian'])){
  $wilayah = $_POST['bagian'];
  $query = "INSERT INTO bagian (id_bagian,bagian,status) VALUES (NULL,'".$wilayah."',1)";
...
$query = "SELECT * FROM bagian LIMIT $i,1";
$result = mysqli_query($koneksi, $query);
?>
...
<div class="row form">
  ...
  <div class="panel-body text-center">
    <Form method="POST" action="bagian.php">
        <p class="username login">Nama Bagian</p>
        <input type="text" name="bagian"><br><br>
